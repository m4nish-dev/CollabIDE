...
function fireConfetti() {
  ...
  confetti({ ...defaults, particleCount: Math.floor(count * 0.25), spread: 26, startVelocity: 55, colors: ['#7C5CFF', '#22D3EE'] })
  confetti({ ...defaults, particleCount: Math.floor(count * 0.2),  spread: 60, colors: ['#7C5CFF', '#EC4899'] })
  confetti({ ...defaults, particleCount: Math.floor(count * 0.35), spread: 100, decay: 0.91, scalar: 0.8, colors: ['#22D3EE', '#7C5CFF'] })
  confetti({ ...defaults, particleCount: Math.floor(count * 0.1),  spread: 120, startVelocity: 25, decay: 0.92, scalar: 1.2, colors: ['#F59E0B', '#10B981'] })
  confetti({ ...defaults, particleCount: Math.floor(count * 0.1),  spread: 120, startVelocity: 45, colors: ['#7C5CFF', '#22D3EE'] })
}
  ...
  >
    ...
    >
      ...
      <div>
        ...
        <p className="mt-2 text-foreground-muted">Taking you to your dashboard…</p>
      </div>
