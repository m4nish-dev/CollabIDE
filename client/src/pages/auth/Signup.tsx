...
import {
  OAuthButton, AuthDivider, FormField,
  ...
  return (
    <AuthLayout>
      ...
      <div className="mb-8">
        ...
        <p className="mt-1.5 text-sm text-foreground-muted">Start collaborating in seconds</p>
      </div>
        ...
        <div className="space-y-1">
          <label className="flex items-start gap-2.5 cursor-pointer">
            ...
            <span className="text-xs text-foreground-muted leading-relaxed">
              I agree to the{' '}
              <a href="#" className="text-foreground hover:text-accent transition-colors underline-offset-2 underline">Terms of Service</a>
              {' '}and{' '}
              <a href="#" className="text-foreground hover:text-accent transition-colors underline-offset-2 underline">Privacy Policy</a>
            </span>
          </label>
          {errors.terms && (
            <p className="text-xs text-danger" role="alert">{errors.terms.message}</p>
          )}
        </div>
