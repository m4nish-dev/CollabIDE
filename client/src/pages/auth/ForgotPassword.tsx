        ...
        {!sent ? (
          ...
          >
            <div className="mb-8">
              ...
              <p className="mt-1.5 text-sm text-foreground-muted">We&apos;ll email you a secure reset link</p>
            </div>
            ...
            <div className="mt-6 text-center">
              <Link to="/login" className="inline-flex items-center gap-1.5 text-sm text-foreground-muted hover:text-foreground transition-colors">
          ...
          >
            ...
            <p className="mt-1.5 text-xs text-foreground-subtle">Didn&apos;t receive it? Check spam or try another email.</p>
