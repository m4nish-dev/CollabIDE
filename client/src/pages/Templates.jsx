      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-border pb-6">
        <div>
          ...
          <p className="text-sm text-foreground-muted mt-1 leading-relaxed max-w-2xl">
            Start your next project from a proven starting point. Each template
            comes pre-configured with language runtimes, build tools, and
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle at center, ${template.accentColor} 0%, transparent 70%)`,
                  }}
                />
