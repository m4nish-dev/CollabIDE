...
export type SourceType = 'blank' | 'template' | 'github'
...
const INLINE_TEMPLATES = [
  ...
  { id: 'vanilla-html', name: 'Vanilla HTML/CSS/JS', icon: 'html', tag: 'No-Build' },
          ...
          <AnimatePresence mode="wait">
            {step === 1 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
                  ...
                  >
                    <div>
                      ...
                      <div className="text-sm font-semibold text-foreground">Blank Project</div>
                      <p className="text-xs text-foreground-muted mt-1 leading-relaxed">
                        Start with an empty directory and scaffold your files from scratch.
                      </p>
                    </div>
                    <div className="mt-4 flex items-center text-[11px] font-medium text-accent opacity-0 group-hover:opacity-100 transition-opacity">
                      <span>Select</span> <ArrowRight size={11} className="ml-1" />
                    </div>
                  </button>
                  ...
                  >
                    <div>
                      ...
                      <div className="text-sm font-semibold text-foreground">From Template</div>
                      <p className="text-xs text-foreground-muted mt-1 leading-relaxed">
                        Choose from proven boilerplates like Next.js, React, Node.js, and Python.
                      </p>
                    </div>
                    <div className="mt-4 flex items-center text-[11px] font-medium text-accent opacity-0 group-hover:opacity-100 transition-opacity">
                      <span>Select</span> <ArrowRight size={11} className="ml-1" />
                  ...
                  >
                    <div>
                      ...
                      <div className="text-sm font-semibold text-foreground">Import from GitHub</div>
                      <p className="text-xs text-foreground-muted mt-1 leading-relaxed">
                        Clone a public or private GitHub repository and keep it synced.
                      </p>
                    </div>
                    <div className="mt-4 flex items-center text-[11px] font-medium text-accent opacity-0 group-hover:opacity-100 transition-opacity">
                      <span>Select</span> <ArrowRight size={11} className="ml-1" />
              ...
              >
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                      {INLINE_TEMPLATES.map(t => {
                        ...
                        return (
                          ...
                          >
                            <FrameworkIcon name={t.icon} size={18} className="text-accent shrink-0" />
                  ...
                  <div className="space-y-3 p-3.5 rounded-xl border border-border bg-background/50">
                    <div className="space-y-1.5">
                      <label className="text-xs font-semibold text-foreground flex items-center justify-between">
                        <span>GitHub Repository URL <span className="text-danger">*</span></span>
                        <span className="text-[11px] text-foreground-subtle font-normal">Public or Private</span>
                      </label>
                      <Input
                        value={githubUrl}
                        onChange={e => {
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-foreground-subtle pointer-events-none" />
                      </div>
                    </div>
                  </div>
                )}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-foreground">Target Workspace</label>
                  <div className="relative">
                    <select
                    ...
                    {[
                      ...
                      return (
                        <button
                          key={v.id}
                          type="button"
                          onClick={() => setVisibility(v.id as VisibilityType)}
                          className={cn(
                        ...
                        >
                          <div className="flex items-center justify-between mb-1.5">
                            <Icon size={14} className={isSelected ? 'text-accent' : 'text-foreground-subtle'} />
