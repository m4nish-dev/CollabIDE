    ...
    <div className="flex h-screen w-full overflow-hidden bg-background">
      ...
      <div className="relative flex w-full flex-col lg:max-w-[480px] overflow-y-auto">
        ...
        <div className="px-8 pb-6 text-center text-[11px] text-foreground-subtle">
          ...
          <a href="#" className="text-foreground-muted hover:text-foreground underline-offset-2 hover:underline transition-colors">Terms</a>
          {' '}and{' '}
          <a href="#" className="text-foreground-muted hover:text-foreground underline-offset-2 hover:underline transition-colors">Privacy Policy</a>
        </div>
      </div>
